 ...
 */
public class ProSignListCallback extends Callback<ListResult<ProSign>> {
    @Override
    public ListResult<ProSign> parseNetworkResponse(Response response) throws Exception {
        ...
        ListResult<ProSign> result;
        Gson _g = new GsonBuilder().serializeNulls().create();
        result = _g.fromJson(obj,new TypeToken<ListResult<ProSign>>(){}.getType());
        return result;
    }
